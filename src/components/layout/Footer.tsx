      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            >
              <span className="text-primary-800 font-bold text-xl">OmniDimension</span>
              <span className="text-accent-600 font-light text-xl ml-1">AI</span>
            </motion.div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              ...
              <a 
                href="mailto:contact@omnidimension.ai" 
                className="text-neutral-600 hover:text-primary-600 transition-colors"
                aria-label="Email"
              >
                <Mail size={20} />
            ...
            <p className="text-neutral-500 text-xs">
              © {new Date().getFullYear()} OmniDimension AI. All rights reserved.
            </p>
          </div>
        </div>
      </div>
